...
public abstract class StringUtils {
    ...
    public static String cleanPath(String path) {
        ...
        return (new StringBuilder(String.valueOf(prefix))).append(collectionToDelimitedString(pathElements, "/")).toString();
    }
    ...
    public static String toLanguageTag(Locale locale) {
        return (new StringBuilder(String.valueOf(locale.getLanguage()))).append(hasText(locale.getCountry()) ? (new StringBuilder("-")).append(locale.getCountry()).toString() : "").toString();
    }
